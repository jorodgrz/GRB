...
mergers. In the \citet{gottlieb2023,gottlieb2024} framework the two are set
apart not by burst duration but by the central engine, a hyper-massive neutron
star (HMNS) or a black-hole accretion disk. We classify the
\citet{broekgaarden2021} \compas\ binary populations by engine and compute their
cosmic merger rates under the \citet{levina2026} TNG100-1 star-formation
history. Four results follow. First, long-duration engines dominate the binary
neutron star (BNS) population: 76\% in the fiducial model, and 72 to 88\% across
the full 20-model grid, against a short-duration, blue-kilonova minority of 24\%
(12 to 28\% across the grid). Black hole neutron star (BHNS) mergers instead
mostly swallow the neutron star and make no burst (76\%). Second, the BNS local
rate ($55\,\Gpcyr$; grid range $0.6$ to $232$) agrees with the LVK GWTC-5.0
measurement, but the BHNS rate ($84.5\,\Gpcyr$; range $4.7$ to $442$) sits a
factor $\sim 2.6$ above the NSBH 90 percent upper bound and exceeds the region
in 14 of the 20 models: \compas\ generically overpredicts the NSBH rate. Third,
the engine, not the duration, sets the kilonova: against the
\citet{rastinejad2024} sample and an external long-merger-GRB anchor,
long-duration bursts sit $+0.7$ dex above the black-hole-disk prediction while
short-duration bursts lie $+2.4$ dex above it (a $+1.65$ dex separation), near
the HMNS expectation. Fourth, across the binary-physics grid the local rate
varies by two orders of magnitude but the class ordering does not: the
long-duration majority is the robust prediction in every binary-physics
variation, while the exact fractions, and in the stiff-EOS (DD2) limit the
ordering itself, are set by the dense-matter equation of state. All GRB rates
are upper limits, since they assume every above-threshold system launches a
jet.
\end{abstract}
...
are called out repeatedly: the common-envelope efficiency, bracketed by F
($\alpha_{\rm CE} = 0.5$) and G ($\alpha_{\rm CE} = 2.0$), and the maximum NS
mass, bracketed by J ($M_{\rm NS,max} = 2.0\,\Msun$) and K
...
\tablehead{
\colhead{Model} & \colhead{Paper I} & \colhead{Varied assumption} & \colhead{$\alpha_{\rm CE}$} &
\colhead{$M_{\rm NS,max}$} & \colhead{SN remnant engine} &
\colhead{BNS $N$ ($n_{\rm eff}$)} & \colhead{BHNS $N$ ($n_{\rm eff}$)} \\
\colhead{(Paper II)} & \colhead{} & \colhead{} & \colhead{} & \colhead{($\Msun$)} & \colhead{} & \colhead{} & \colhead{}
}
\startdata
A & A\tablenotemark{a}        & Fiducial                                            & 1.0 & 2.5 & delayed & $233{,}137$ ($65{,}134$)      & $1{,}525{,}553$ ($292{,}484$) \\
G & alpha0p1\tablenotemark{b} & $\alpha_{\rm CE} = 0.1$                             & 0.1 & 2.5 & delayed & $345{,}779$ ($207{,}909$)     & $22{,}395$ ($7{,}418$) \\
H & F\tablenotemark{a}        & $\alpha_{\rm CE} = 0.5$                             & 0.5 & 2.5 & delayed & $64{,}260$ ($16{,}488$)       & $915{,}179$ ($113{,}902$) \\
I & G\tablenotemark{a}        & $\alpha_{\rm CE} = 2.0$                             & 2.0 & 2.5 & delayed & $1{,}052{,}472$ ($399{,}336$) & $833{,}433$ ($385{,}378$) \\
J & alpha10\tablenotemark{b}  & $\alpha_{\rm CE} = 10$                              & 10  & 2.5 & delayed & $579{,}059$ ($330{,}218$)     & $441{,}924$ ($278{,}983$) \\
...
F & EH\tablenotemark{b} & Unstable case BB plus optimistic CE                       & 1.0 & 2.5 & delayed & $7{,}491$ ($4{,}490$)         & $828{,}558$ ($44{,}525$) \\
K & H & Optimistic CE (HG donors survive CE)                                        & 1.0 & 2.5 & delayed & $234{,}963$ ($35{,}646$)      & $1{,}535{,}042$ ($55{,}884$) \\
L & I & Rapid SN remnant prescription                                               & 1.0 & 2.5 & rapid   & $146{,}467$ ($43{,}297$)      & $2{,}766{,}298$ ($974{,}073$) \\
M & J\tablenotemark{a}        & $M_{\rm NS,max} = 2.0\,\Msun$                       & 1.0 & 2.0 & delayed & $213{,}669$ ($58{,}125$)      & $959{,}796$ ($189{,}149$) \\
N & K\tablenotemark{a}        & $M_{\rm NS,max} = 3.0\,\Msun$                       & 1.0 & 3.0 & delayed & $238{,}111$ ($68{,}058$)      & $1{,}990{,}330$ ($423{,}846$) \\
O & L & No (pulsational) pair-instability SNe                                       & 1.0 & 2.5 & delayed & $233{,}190$ ($65{,}787$)      & $1{,}524{,}497$ ($289{,}381$) \\
P & M & CCSN kick $\sigma_{\rm kick} = 100\,{\rm km\,s^{-1}}$                       & 1.0 & 2.5 & delayed & $415{,}335$ ($107{,}644$)     & $3{,}049{,}458$ ($691{,}439$) \\
Q & N & CCSN kick $\sigma_{\rm kick} = 30\,{\rm km\,s^{-1}}$                        & 1.0 & 2.5 & delayed & $626{,}019$ ($180{,}711$)     & $4{,}198{,}238$ ($1{,}077{,}213$) \\
R & O & No BH natal kick                                                            & 1.0 & 2.5 & delayed & $155{,}208$ ($51{,}465$)      & $5{,}068{,}628$ ($1{,}685{,}390$) \\
S & fWR0p1\tablenotemark{b}   & Wolf-Rayet wind multiplier $f_{\rm WR} = 0.1$       & 1.0 & 2.5 & delayed & $191{,}544$ ($58{,}259$)      & $1{,}379{,}487$ ($301{,}322$) \\
T & fWR5\tablenotemark{b}     & Wolf-Rayet wind multiplier $f_{\rm WR} = 5$         & 1.0 & 2.5 & delayed & $276{,}279$ ($71{,}624$)      & $938{,}755$ ($198{,}429$) \\
\enddata
\tablenotetext{a}{Fiducial Model A and the common-envelope and
maximum-NS-mass brackets (F, G, J, K) called out most directly in the text;
all 20 variations enter the Section~\ref{sec:grid} sweeps.}
...
instability, natal kicks, winds); Figure~\ref{fig:frac20} sorts models by
class fraction instead. Each variation changes one
...
5178777). The Model column gives the \citet{broekgaarden2022} paper II
letter under which both Zenodo records package the variation, so files
retrieved from the records are matched by this letter; the Paper I column
gives the \citet{broekgaarden2021} letters (descriptive tokens for the five
paper-II-only variations) used in the text. The two conventions diverge after
model E (paper II K is the optimistic-CE variation, not
$M_{\rm NS,max} = 3.0\,\Msun$). $N$ is the raw number of merging systems in
the catalog and $n_{\rm eff}$ the Kish effective sample size of its
STROOPWAFEL weights (Section~\ref{sec:populations}); the Model A entries match
...
the maximum-NS-mass brackets of Section~\ref{sec:grid}: the remapped NS-mass
distribution is identical (capped at $2.2\,\Msun$) for Model~J
($M_{\rm NS,max} = 2.0\,\Msun$), the fiducial, and Model~K
...
versus black-hole remnant-type assignment (which sets how many systems are
BNS rather than BHNS), not through the NS masses fed to the classifier; this is
the channel through which the BHNS rate still deepens with $M_{\rm NS,max}$
...
is spin-independent). The headline class fractions and local rates are collected
in Table~\ref{tab:classfrac}: roughly three-quarters of BNS mergers fall in the
...
$n_{\rm eff}$ is the Kish effective sample size. Class-fraction uncertainties are
resampling-bootstrap 16-84 percentile intervals
(\texttt{grb\_rates.bootstrap\_class\_fractions}, $n_{\rm boot} = 500$):
$24.0\,[23.8, 24.2]$, $26.8\,[26.6, 27.0]$, $2.2\,[2.1, 2.3]$, and
$47.0\,[46.9, 47.3]$ percent for the four BNS classes, and $3.8\,[3.8, 3.9]$,
$20.6\,[20.5, 20.7]$, and $75.6\,[75.5, 75.7]$ percent for BHNS. The per-class
half-widths ($\le 0.2$ percentage points for BNS, $\le 0.1$ for BHNS) are far
below the systematic bands of Sections~\ref{sec:classrates} to \ref{sec:spin},
so sampling error is not whiskered on any class fraction. Rates are intrinsic, comoving,
...
and therefore consistent with the per-model rates of
Figure~\ref{fig:frac20}; BHNS rates are intrinsic at $\aBH = 0.5$ without
...
(Figure~\ref{fig:rateclass}); the fraction of those jets that actually break out
and the rate that survives beaming (Figure~\ref{fig:breakout}); the black-hole
...
anchored on an external long-merger-GRB $E_{\gamma,\rm iso}$ sample
($\langle\log_{10}E_{\gamma,\rm iso}/{\rm erg}\rangle = 51.6 \pm 0.7$, $N = 5$;
060614, 211227A, 191019A, 211211A, 230307A, sourced in the text), the dashed
envelope adds the $f_b/\epsilon_\gamma$ range, and the green strip is the HMNS
disk-wind $M_{\rm ej} = 0.3\,\Mdisk$ prior (\citealt{gottlieb2024}, their
Sec.~3.1); error bars are 68 percent on $M_{\rm ej,tot}$ and $T_{50}$.
\textit{Right:} residual $\log_{10}(M_{\rm obs,wind}/M_{\rm pred,BH})$ versus
$T_{50}$, with the BH-engine null at zero (gray) and the pooled HMNS-engine
expectation bands at 68 percent. The BH null is anchored on the same external
sample, not on the in-sample lbGRBs, so the lbGRB residual is not measured
against itself; GW170817 keeps its per-event on/off-axis energetics. Per-event
residuals span the Monte Carlo 16th to 84th percentiles, marginalized over the
disk-mass and wind-fraction priors. Asterisked events (open markers in the
...
unstable case~BB) to $232\,\Gpcyr$ (Model~N), and stays within the GWTC-5.0
BNS region $[5.1, 154.7]\,\Gpcyr$ for the fiducial and its neighbours: $55.0$
(A), $29.3$ (F, $\alpha_{\rm CE} = 0.5$), $106.0$ (G, $\alpha_{\rm CE} = 2.0$),
$53.7$ (J), and $56.9\,\Gpcyr$ (K). Over the grid the lbGRB-producing classes
hold 72 to 88 percent of the BNS population and the sbGRB-plus-blue class stays
a 12 to 28 percent minority, so the long-duration-majority ordering is
grid-wide rather than fiducial-specific (Section~\ref{sec:systematics}). The BHNS rate ranges from $4.7$ (Model~$\alpha_{\rm CE} = 0.1$) to
$442\,\Gpcyr$ (Model~N); 14 of the 20 variations exceed the tightened NSBH
...
Model~J has $M_{\rm NS,max} = 2.0\,\Msun < \Mtov = 2.2\,\Msun$, so
...
\citep[shaded]{abac2026}. The resampling-bootstrap 16-84 interval on each class
fraction (Section~\ref{sec:results}) has a half-width below $0.4$ percentage
points for every well-sampled model, rising to a few percentage points only for
the lowest-$n_{\rm eff}$ variation (Model E, unstable case BB); the
MSSFR-resolution systematic ($\sim \pm 30$ percent) is common to all
models; the composition is far more stable across the grid than the rate. All
GRB rates are intrinsic upper bounds; models use the \citet{broekgaarden2021}
paper I letters and descriptive tokens of Table~\ref{tab:models}.
\label{fig:frac20}}
\end{figure*}
...
$M_{\rm NS,max}$ axis (sharpest at $M_{\rm NS,max} = 3.0\,\Msun$, Model K) but
not isolated to it; in absolute terms the reduced-kick Model N overshoots most
...
the $M_{\rm NS,max}$ axis (sharpest at the highest $M_{\rm NS,max}$, Model K),
though the largest absolute overshoot is the reduced-kick Model N.
...
($+5.2\sigma$) above it and far closer to the HMNS disk-wind expectation, a
$+1.65$ dex short-versus-long separation; this inverts the naive
